const e={connectionFailed:"TTS WebSocket 연결 실패",connectedMessage:"음성 연결이 설정되었습니다.",disconnectedMessage:"TTS 연결이 해제되었습니다.",disconnectButton:"연결 해제",reconnectButton:"재연결",connectingMessage:"음성(TTS) 연결 중..."},t={fetchListFailed:"방송 목록을 불러오는데 실패했습니다",responseNotArray:"응답이 배열 형식이 아닙니다",setStatusFailed:"방송 상태 변경 실패"},n={faceObjectNotFound:"Face 오브젝트를 찾을 수 없습니다.",morphTargetDictionaryNotFound:"morphTargetDictionary를 찾을 수 없습니다.",targetNotFound:"타겟 '{targetName}'을(를) 찾을 수 없습니다."},o={explore:"탐색",feed:"피드",create:"생성",settings:"마이",chat:"채팅"},a={title:"채팅",noChats:"아직 대화가 없습니다",startNewChat:"새로운 페르소나와 대화를 시작해보세요.",goExplore:"탐색하러 가기"},i={title:"내 페이지",logout:"로그아웃",credits:"내 뉴런",plan:"플랜",charge:"뉴런 충전",myPersonas:"내 AI 페르소나",newPersona:"+ 새 AI 페르소나",broadcastStart:"방송 시작",broadcastEnd:"방송 종료",auctionStart:"경매 시작",edit:"편집",delete:"삭제",deleteConfirm:"페르소나 '{name}'을(를) 정말 삭제하시겠습니까? 이 작업은 되돌릴 수 없습니다.",editProfile:"수정",save:"저장",cancel:"취소",liked:"좋아요",following:"팔로잉",noLiked:"아직 좋아요한 페르소나가 없습니다.",noFollowing:"아직 팔로우한 크리에이터가 없습니다.",makePrivate:"캐릭터를 비공개로 전환",makePublic:"캐릭터를 공개로 전환"},r={deleteAccount:"회원 탈퇴",deleteAccountConfirm:"정말로 탈퇴하시겠습니까? 이 작업은 되돌릴 수 없으며, 모든 개인 데이터가 삭제됩니다. (페르소나는 보존됩니다)",deleteAccountSuccess:"회원 탈퇴가 완료되었습니다.",deleteAccountFail:"회원 탈퇴에 실패했습니다.",korean:"한국어",english:"영어",description:"앱의 표시 언어와 테마를 변경하세요.",language:"언어",title:"설정",theme:"테마",light:"라이트",dark:"다크"},s={noConversation:"{name}님과 대화를 시작해보세요!",thinking:"생각 중"},c={hide:"사이드바 숨기기",show:"사이드바 보기",exitFullscreen:"전체화면 종료",enterFullscreen:"전체화면 시작",tutorial:"튜토리얼",community:"커뮤니티 참여"},l={placeholder:"{name}에게 말을 걸어보세요...",sendButton:"보내기",generateSituationImage:"✨ 상황 이미지 생성",generatingImage:"생성 중...",cost:"10 뉴런"},d={placeholder:"채팅을 입력하세요...",sendButton:"보내기"},m={githubSoon:"깃허브 로그인은 아직 준비 중입니다.",emailSoon:"이메일 로그인은 아직 준비 중입니다.",signIn:"로그인",signUp:"회원가입",terms:"이용약관",privacy:"개인정보 처리방침",serviceLogoAlt:"서비스 로고",loginWith:"{provider}로 로그인",welcomeBack:"환영합니다!",slogan:"당신만의 AI 페르소나를 만드세요."},g={createFailed:"경매 생성 실패"},u={bidTooLow:"입찰가는 현재 최고 입찰가({currentHighestBid} 뉴런)보다 높아야 합니다.",bidIncrementError:"입찰가는 {minBidIncrement} 뉴런 단위로 입력해주세요.",bidError:"입찰 중 오류가 발생했습니다.",title:"경매 입찰하기",currentHighestBid:"현재 최고 입찰가",creditsUnit:"뉴런",minBidIncrement:"최소 입찰 단위",bidCredits:"입찰 뉴런",minBidPlaceholder:"이상",biddingInProgress:"입찰 중...",placeBid:"입찰하기",cancel:"취소"},p={pack100Name:"기본 뉴런 팩",pack300Name:"실속 뉴런 팩",pack500Name:"프리미엄 뉴런 팩",pack1000Name:"무제한 뉴런 팩 (한정)",pack50Name:"맛보기 뉴런",purchaseLog:"결제 요청: {name} ({price}원) - {credits} 뉴런 추가",purchaseAlert:'"{name}" 결제 기능을 개발 중입니다! (실제 결제는 이루어지지 않습니다.)',creditLowTitle:"⚠️ 뉴런이 부족합니다!",creditLowMessage1:"더 많은 캐릭터 챗을 이용하시려면 뉴런을 충전해주세요.",creditLowMessage2:"아래에서 원하는 뉴런 팩을 선택하여 충전할 수 있습니다.",chargeCreditsTitle:"뉴런 충전하기",chargeCreditsMessage:"원하는 뉴런 팩을 선택하여 더 많은 기능을 이용해보세요.",creditsUnit:"뉴런",currencyUnit:"원",purchaseButton:"구매하기",contactSupport:"결제 관련 문의는 고객센터로 연락주세요."},h={title:"채팅 설정",guidanceText:"* 모든 설정은 현재 채팅 세션에만 영향을 줍니다.",llmTitle:"AI 모델",llmDescription:"이 채팅에서 사용할 AI 모델을 선택하세요. 모델마다 다른 개성과 비용이 발생할 수 있습니다.",feedbackTitle:"피드백",like:"좋아요",liked:"좋아요 함",share:"공유하기",chatManagement:"대화 관리",resetChat:"대화 초기화",deleteChat:"대화 삭제",confirmReset:"대화 기록을 정말 초기화하시겠습니까? 이 작업은 되돌릴 수 없습니다.",confirmDelete:"이 채팅 세션을 영구적으로 삭제하시겠습니까?",includeAllUtterances:"모든 발화 포함",neuronsConsumed:"뉴런이 소모 됩니다.",costDisplay:"응답 당 :",neuronBalance:"현재 뉴런: ",showImage:"보기",hideImage:"숨기기",report:"신고하기"},y={title:"신고하기",selectType:"신고 사유",types:{spam:"스팸 / 부적절한 홍보",inappropriate:"부적절한 콘텐츠",copyright:"저작권 침해",other:"기타"},details:"상세 내용",placeholder:"신고 사유를 자세히 적어주세요.",submit:"신고 제출",thanks:"신고가 접수되었습니다.",thanksMessage:"검토 후 조치하겠습니다."},b={searchTitle:"페르소나 검색",all:"전체",noResults:"표시할 페르소나가 없습니다.",searchByName:"이름으로 검색",searchByTags:"태그로 검색",searchNamePlaceholder:"페르소나의 이름을 입력하세요...",searchTagsPlaceholder:"태그를 쉼표(,)로 구분하여 입력...",following:"팔로잉",likes:"좋아요",auctionInProgress:"경매 중",categories:"카테고리",toggleCategories:"카테고리 토글",searchResult:'"{query}" 검색 결과',nav:{home:"홈",character:"캐릭터",story:"스토리",companion:"동반자","2d":"2D","3d":"3D"}},L={newArrivals:"새로운 만남",todaysPopular:"화제의 중심",live2dTitle:"살아 숨 쉬는 그림",vrmTitle:"입체적인 존재감",allPersonas:"전체 컬렉션",fantasy:"환상적인 이야기"},f={bidder:"입찰자",auctionEnded:"경매 종료!",dayUnit:"일",hourUnit:"시",minuteUnit:"분",secondUnit:"초",noTimeInfo:"시간 정보 없음",myCredits:"내 뉴런",highestBid:"최고 입찰가",creditsUnit:"뉴런",remainingTime:"남은 시간",currentLeader:"현재 선두",placeBidButton:"입찰하기",calculatingTime:"시간 계산 중..."},P={privacyPolicy:"개인정보처리방침",termsOfService:"이용약관",licensesAndCredits:"라이선스 · 뉴런",chatLogConsent:"채팅/로그 수집 동의",title:"정책"},T={loadError:"라이선스 정보를 불러오는 데 실패했습니다.",pageTitle:"라이선스 및 뉴런 - [사이트/서비스 이름]"},v={loadError:"개인정보처리방침을 불러오는 데 실패했습니다.",pageTitle:"개인정보처리방침 - [사이트/서비스 이름]"},k={loadError:"채팅 및 로그 수집 동의 정보를 불러오는 데 실패했습니다.",pageTitle:"채팅 및 로그 수집 동의 - [사이트/서비스 이름]"},D={loadError:"이용약관을 불러오는 데 실패했습니다.",pageTitle:"이용약관 - [사이트/서비스 이름]"},S={title:"튜토리얼",description:"서비스 이용 방법을 확인해보세요.",iframeTitle:"튜토리얼 문서"},C={viewer1:"시청자1",viewer1Message:"이 캐릭터 뭐야 ㅋㅋ",viewer2:"시청자2",viewer2Message:"존예다 ㄹㅇ",viewer3:"시청자3",viewer3Message:"대답함??",me:"나",websocketDisconnected:"🔌 WebSocket 연결 해제",broadcastContent:"방송 콘텐츠"},w={system:{search:"탐색",user:"사용자",feed:"피드",create:"만들기",legal:"법률"}},M={interact:"대화",alreadyFeedback:"You have already {action} this persona.",feedbackFailed:"Failed to {action} persona: {message}",unexpectedError:"An unexpected error occurred. Please try again."},A={feedbackButtonLabel:"피드백 보내기",feedbackButtonText:"피드백"},B={submitFailed:"피드백 제출에 실패했습니다. 나중에 다시 시도해 주세요.",thanks:"소중한 의견 감사합니다!",thanksMessage:"여러분의 피드백은 더 나은 서비스를 만드는 데 큰 도움이 됩니다.",title:"개발자에게 익명으로 피드백 보내기",body1:"어떤 의견이든 환영합니다. 욕설과 비판도 기꺼이 듣겠습니다.",body2:"여러분의 소중한 피드백은 서비스 개선에 큰 힘이 됩니다.",sending:"전송 중...",send:"피드백 보내기",placeholder:"여기에 피드백을 입력해 주세요..."},I={title:"PersonaXI에 오신 것을 환영합니다!",message:"PersonaXI에 가입해주셔서 감사합니다. 즐거운 시간 되시길 바랍니다!",neuronReward:"환영 선물로 {amount} 뉴런이 지급되었습니다!",confirmButton:"탐험 시작하기"},F={title:"뉴런이 부족해요!",description:"더 많은 대화를 나누려면 뉴런을 충전해주세요.",rechargeTitle:"뉴런 충전!",rechargeDescription:"더 많은 대화를 나누려면 뉴런을 충전해주세요.",rechargeAlert:"{amount} 뉴런을 선택하셨습니다.",rechargeSuccess:"충전이 완료되었습니다! 뉴런이 지급되었습니다.",firstCreationReward:"페르소나 최초 생성 시 200 뉴런 지급!",getFreeNeurons:"무료 뉴런 받기",currentNeurons:"현재 수량: {count} 뉴런"},N={title:"서비스 이용 동의",privacyPolicyTab:"개인정보처리방침",termsOfServiceTab:"이용약관",chatLogsConsentTab:"채팅 및 로그 데이터 동의",agreePrivacy:"개인정보처리방침에 동의합니다.",agreeTerms:"이용약관에 동의합니다.",agreeChatLogs:"채팅 및 로그 데이터 수집에 동의합니다.",agreeToAll:"모든 약관에 동의합니다.",confirmButton:"확인",alertAllAgreed:"모든 필수 약관에 동의해야 합니다.",privacyPolicyTitle:"개인정보처리방침",privacyPolicyContent:`저희 [사이트/서비스 이름]은(는) 이용자의 개인정보를 소중히 생각하며, 「개인정보보호법」 및 관련 법규를 준수하고 있습니다. 본 개인정보처리방침을 통해 이용자께서 제공하시는 개인정보가 어떠한 용도와 방식으로 이용되고 있으며, 개인정보 보호를 위해 어떠한 조치가 취해지고 있는지 알려드립니다.
