...
최종 업데이트: 2025년 6월 7일`},A={title:"알파 테스트 참여 안내",description1:"이 서비스는 현재 개발 중인 <strong>알파 버전</strong>으로, 여러분과 함께 더 나은 AI 페르소나를 만들어가고자 합니다.",description2:"테스트 기간 동안 <strong>예상치 못한 오류가 발생</strong>하거나 데이터가 임의로 <strong>변경·초기화</strong>될 수 있습니다. 공식 출시를 위해 최선을 다하고 있으니 너른 양해 부탁드립니다.",techStackTitle:"주요 기술 스택",techStackDescription:"이 서비스는 최신 기술을 실험적으로 적용하고 있습니다.",aiModel:"AI 모델:",ttsModel:"음성 모델(TTS):",vrmModel:"3D 모델:",aiWarningTitle:"AI 응답 주의사항",aiWarningDescription:"실험적인 프롬프트 기법을 AI 모델에 적용하고 있어 때때로 <strong>민감하거나 부적절한 답변</strong>을 할 수 있습니다. 이는 보다 자유롭고 인간다운 상호작용을 구현하기 위한 과정의 일부입니다.",confirm:"위 내용을 모두 읽고 이해했습니다."},M={title:"첫 번째 페르소나 생성!",message1:"첫 걸음을 기념하여,",message2:"{amount} 뉴런을 선물로 드렸습니다!",message3:"이제 이 뉴런을 사용해 나만의 '디지털 생명체'와 더 깊은 대화를 나눠보세요.",confirm:"확인"},D={loadingPersona:"캐릭터 정보를 불러오는 중...",imageAlt:"{name} 이미지 {index}",imageMoveLabel:"{index}번 이미지로 이동",creatorInfo:"제작: @{creatorName}",defaultGreeting:"아직 이 캐릭터의 소개가 없습니다.",firstSceneTitle:"시작 이야기",likeButtonLabel:"좋아요",interactionLabel:"상호작용",startChatButton:"채팅 시작",commentsTitle:"응원의 말 ({count})",noComments:"아직 등록된 응원의 말이 없습니다. 첫 응원의 주인공이 되어주세요!",commentPlaceholder:"캐릭터에게 응원의 메시지를 남겨주세요...",registerButton:"등록",personaNotFound:"캐릭터 정보를 찾을 수 없습니다. (T_T)",likeFailed:"좋아요 처리에 실패했습니다: {message}",dummyComments:{author1:"스토리 탐험가",text1:"이 캐릭터 설정 너무 좋아요! 배경 이야기가 더 궁금해지네요.",timestamp1:"3시간 전",author2:"AI 친구",text2:"대화 나눠봤는데 정말 똑똑하고 재밌어요. 강추!",timestamp2:"1일 전",author3:"지나가는 행인",text3:"일러스트가 정말 아름답네요...✨",timestamp3:"2일 전"},defaultProfile:"기본 프로필"},x={invalidAccess:"유효하지 않은 접근입니다.",unknownError:"알 수 없는 오류가 발생했습니다.",connectionError:"인증 서버에 연결할 수 없습니다.",verifyingTitle:"계정을 활성화하는 중입니다...",verifyingMessage:"잠시만 기다려주세요.",successTitle:"인증이 완료되었습니다!",successMessage:"잠시 후 로그인 페이지로 이동합니다.",errorTitle:"인증 실패",backToLogin:"로그인 페이지로 돌아가기"},E={title:"새로운 계정 만들기",slogan:"몇 단계만 거치면 바로 시작할 수 있어요.",label:{email:"이메일 주소",username:"사용자 이름",password:"비밀번호",passwordConfirm:"비밀번호 확인",gender:"성별"},placeholder:{email:"your-email@example.com",username:"세상에 하나뿐인 이름",password:"8자 이상 입력해주세요",passwordConfirm:"비밀번호를 다시 한번 입력해주세요"},gender:{male:"남성",female:"여성",other:"기타"},button:{submit:"계정 만들기",loading:"처리 중..."},error:{emailRequired:"이메일은 필수 항목이에요.",emailInvalid:"올바른 이메일 형식이 아니에요.",usernameRequired:"사용자 이름은 필수 항목이에요.",passwordLength:"비밀번호는 8자 이상이어야 해요.",passwordMismatch:"비밀번호가 서로 일치하지 않아요.",genderRequired:"성별을 선택해주세요.",generic:"오류가 발생했습니다. 잠시 후 다시 시도해주세요.",network:"네트워크 연결을 확인해주세요."},success:{title:"거의 다 됐어요!",message:"{email}(으)로 인증 메일을 보냈어요. 메일을 확인하여 가입을 완료해주세요.",backToLogin:"로그인 화면으로 돌아가기"},alreadyHaveAccount:"이미 계정이 있으신가요?",goToLogin:"로그인하기",prompt:{email:"먼저, 사용하실 이메일 주소를 알려주세요.",username:"멋진 사용자 이름을 만들어 볼까요?",password:"안전하게 사용할 비밀번호를 입력해주세요.",gender:"마지막으로, 성별을 선택해주세요."}},F={back:"뒤로가기"},N={editPage:e,nav:n,settingPage:t,settingPageModal:a,chatWindow:i,sidebar:o,chatInput:r,broadcastChatInput:s,login:c,auctionModal:l,bidModal:d,paymentModal:g,settingModal:m,contentHub:u,auctionPage:p,legal:h,licenses:b,policy:f,privacyChatLogs:v,terms:T,tutorial:L,livePage:P,chatSession:y,feed:I,hub:k,feedbackModal:B,welcomeModal:w,needNeuronsModal:C,consentModal:S,noticeModal:A,firstPersonaCreatedModal:M,profilePage:D,verifyPage:x,register:E,common:F};export{l as auctionModal,p as auctionPage,d as bidModal,s as broadcastChatInput,r as chatInput,y as chatSession,i as chatWindow,F as common,S as consentModal,u as contentHub,N as default,e as editPage,I as feed,B as feedbackModal,M as firstPersonaCreatedModal,k as hub,h as legal,b as licenses,P as livePage,c as login,n as nav,C as needNeuronsModal,A as noticeModal,g as paymentModal,f as policy,v as privacyChatLogs,D as profilePage,E as register,m as settingModal,t as settingPage,a as settingPageModal,o as sidebar,T as terms,L as tutorial,x as verifyPage,w as welcomeModal};
