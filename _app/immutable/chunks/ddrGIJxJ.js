...
{{LEGAL_ENTITY_NAME}}(이하 '회사')는 아래의 오픈소스 소프트웨어와 기술을 활용합니다.
...
1. 회원은 원저작자 또는 배포처 라이선스가 2차 창작, 플랫폼 게시, 공개 범위, 광고·후원·유료 기능 등 해당 이용 형태를 허용하는 경우에만 팬워크 콘텐츠를 공개할 수 있습니다.
2. 팬워크 콘텐츠는 비공식 창작물임을 명확히 표시해야 하며, 공식 작품, 공식 협업, 공식 계정, 권리자 승인 콘텐츠처럼 오인시키면 안 됩니다.
3. 원본 이미지, 모델, 음성, 로고, UI 등 원본 에셋의 실질적 재배포는 금지되며, 필요한 크레딧과 라이선스 표기를 제거, 은폐 또는 허위 기재해서도 안 됩니다.
4. 권리자 신고 또는 합리적인 침해 의심이 발생하면 회사는 해당 콘텐츠에 대해 즉시 비공개, 삭제, 포인트 회수, 업로드 제한, 계정 제한 등 필요한 조치를 할 수 있습니다.
