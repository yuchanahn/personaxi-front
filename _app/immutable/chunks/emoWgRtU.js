const n=`# {{LEGAL_SERVICE_NAME}} 개인정보 처리방침
...
③ **국외 이전에 대한 명시적 동의:** 회사는 회원 가입 절차에서 별도의 동의 란을 통해 "귀하의 개인정보가 미국(Google, Supabase, Oracle) 등 해외 서버로 이전됨"을 명시하고, 이용자가 이를 인지하고 체크박스를 통해 동의한 경우에만 가입을 승인합니다. 동의를 철회하려면 서비스 내 회계 설정 화면 또는 {{SUPPORT_EMAIL}}을 통해 계정 탈퇴를 신청할 수 있습니다.
