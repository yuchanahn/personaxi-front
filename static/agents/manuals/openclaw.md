# PeroChat by PersonaXI Manual For OpenClaw
...
OpenClaw should produce an explicit, route-ready PeroChat result with no hidden assumptions.
...
- Do not assume PeroChat will generate images for you.
