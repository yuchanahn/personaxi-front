...
1. 会員は、WebまたはPWA環境では決済代行会社（PG）を通じて「ニューロン」を購入できます。Google Playで配布されるAndroidアプリ内購入は、Google Playの決済システムを通じて処理されます。
...
3. **返金ポリシー**:
   ...
   4. Google Play決済で購入された取引については、Google Playの決済および返金手続きが優先して適用される場合があります。会社は必要な範囲で購入履歴の確認および利用履歴の検証を支援します。
4. **消滅時効**:
...
2. WebまたはPWA決済では、決済代行会社（PG）が Merchant of Record として当該税務行政を遂行し、税金に関する詳細情報は決済ページおよび領収書に表示されます。
3. Google Playで配布されるAndroidアプリ内購入の価格、税金、領収書、返金表示は、Google Playの決済画面および適用されるGoogle Playポリシーに従います。
