# {{LEGAL_SERVICE_NAME}} 개인정보 처리방침


{{LEGAL_ENTITY_NAME}}(이하 '회사')는 「개인정보 보호법」 제30조에 따라 정보주체의 개인정보를 보호하고 이와 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보 처리방침을 수립·공개합니다.
...
| **Google Play 결제 (Google, LLC)** (미국) | Google Play 계정 정보, 구매 내역, 결제 식별자 | Android 앱 내 구매 처리, 구매 검증, 환불 및 부정 결제 방지 | Google Play 및 법정 보존 기간 종료 시까지 |
...
② 제1항에 따른 권리 행사는 전자우편({{PRIVACY_EMAIL}}) 등을 통하여 하실 수 있습니다.
...
2. **기술적 조치:** 접근권한 관리, 접속기록 위변조 방지, 주요 데이터 암호화(저장 및 전송 시), SSL 보안 서버 적용, 정기적 보안 취약점 점검, 실시간 렌더링 제공 과정에서의 전송 구간 보호 및 접근 통제
...
③ 정보주체는 본인의 개인정보 보호와 관련하여 피해를 당한 경우, 피해구제를 위한 신청을 아래의 기관에 제기할 수 있습니다.
...
④ 위의 권리를 행사하려면 {{PRIVACY_EMAIL}}으로 문의하시며, 회사는 요구일로부터 30일 이내에 적절한 조치를 취하겠습니다.

---

### 제12조 (변경에 관한 사항)

① 이 개인정보 처리방침은 2026년 04월 15일부터 적용됩니다.

② 개인정보 처리방침의 내용 추가 또는 수정·변경이 있는 경우에는 변경일 이전에 서비스 내 공지를 통해 안내합니다.

---

**개인정보 보호책임자:** 안유찬 ({{PRIVACY_EMAIL}})
